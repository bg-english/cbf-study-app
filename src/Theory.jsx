...
// Reusable sub-components for theory cards
  ...
  return (
    <div className="section">
      <div className="section-header">
        ...
        <p>Detailed explanations of every topic in your Language Arts exam. Study each section, open the accordions, and check the examples until you feel confident.</p>
      </div>
          ...
          <div style={{ overflowX: 'auto' }}>
            <table className="tense-table">
              ...
              <tbody>
                <tr>
                  <td>Habit vs. now</td>
                  <td><em>He <strong>reads</strong> every morning.</em> (habit)</td>
                  <td><em>He <strong>is reading</strong> right now.</em> (at this moment)</td>
                </tr>
                <tr>
                  <td>Permanent vs. temporary</td>
                  <td><em>She <strong>lives</strong> in Barranquilla.</em> (permanent)</td>
                  <td><em>She <strong>is living</strong> with her grandma this month.</em> (temporary)</td>
                </tr>
                <tr>
                  <td>General fact vs. in progress</td>
                  <td><em>It <strong>rains</strong> a lot in April.</em> (general truth)</td>
                  <td><em>It <strong>is raining</strong> right now.</em> (in progress)</td>
                </tr>
                <tr>
                  <td>Stative verb (always simple)</td>
                  <td><em>He <strong>has</strong> a dog.</em> (ownership)</td>
                  <td><em>She <strong>is having</strong> lunch.</em> (action = eating)</td>
                </tr>
              </tbody>
            </table>
          </div>
      ...
      <div className="card">
        ...
        <Accordion title="🔧 Formation — Regular & Irregular Verbs" icon="🔧" defaultOpen={true}>
          ...
          <div style={{ overflowX: 'auto' }}>
            <table className="tense-table">
              <thead>
                <tr><th>Base form</th><th>Past Simple</th><th>Base form</th><th>Past Simple</th><th>Base form</th><th>Past Simple</th></tr>
              </thead>
              <tbody>
                ...
                <tr><td>cost</td><td><strong>cost</strong></td><td>have</td><td><strong>had</strong></td><td>swim</td><td><strong>swam</strong></td></tr>
                <tr><td>cut</td><td><strong>cut</strong></td><td>hear</td><td><strong>heard</strong></td><td>take</td><td><strong>took</strong></td></tr>
                <tr><td>do</td><td><strong>did</strong></td><td>hold</td><td><strong>held</strong></td><td>teach</td><td><strong>taught</strong></td></tr>
                <tr><td>drink</td><td><strong>drank</strong></td><td>hurt</td><td><strong>hurt</strong></td><td>tell</td><td><strong>told</strong></td></tr>
                <tr><td>drive</td><td><strong>drove</strong></td><td>know</td><td><strong>knew</strong></td><td>think</td><td><strong>thought</strong></td></tr>
                <tr><td>eat</td><td><strong>ate</strong></td><td>leave</td><td><strong>left</strong></td><td>wake</td><td><strong>woke</strong></td></tr>
                <tr><td>fall</td><td><strong>fell</strong></td><td>make</td><td><strong>made</strong></td><td>win</td><td><strong>won</strong></td></tr>
                <tr><td>fight</td><td><strong>fought</strong></td><td>meet</td><td><strong>met</strong></td><td>write</td><td><strong>wrote</strong></td></tr>
              </tbody>
            </table>
          </div>
        </Accordion>
        ...
        <Accordion title="📌 When to use Past Simple — 4 Uses" icon="📌" defaultOpen={true}>
          ...
          <div style={{ background: '#dcfce7', borderRadius: 10, padding: '1rem', marginBottom: '1rem' }}>
            ...
            <p style={{ fontSize: '0.88rem', marginTop: 4, marginBottom: 6 }}>When several actions happened one after another in the past.</p>
            ...
            <ExBox correct={true}>He <strong>opened</strong> the door, <strong>walked</strong> in, and <strong>sat</strong> down.</ExBox>
          </div>

          <div style={{ background: '#fce7f3', borderRadius: 10, padding: '1rem', marginBottom: '1rem' }}>
            <strong style={{ color: '#831843' }}>USE 3 — The Interrupting Action (with Past Continuous)</strong>
            <p style={{ fontSize: '0.88rem', marginTop: 4, marginBottom: 6 }}>The shorter action that <strong>interrupts</strong> a longer ongoing action. Past Simple = the interruption.</p>
            ...
            <ExBox correct={true}>The kids were playing <strong>when</strong> it <strong>started</strong> to rain.</ExBox>
          </div>

          <div style={{ background: '#eff6ff', borderRadius: 10, padding: '1rem' }}>
            <strong style={{ color: '#1e40af' }}>USE 4 — Past Facts & States</strong>
            <p style={{ fontSize: '0.88rem', marginTop: 4, marginBottom: 6 }}>A situation or state that existed in the past but no longer does (can also use "used to").</p>
            ...
            <ExBox correct={true}>They <strong>didn't have</strong> a computer in those days.</ExBox>
          </div>
        </Accordion>
      ...
      <div className="card">
        ...
        <Accordion title="🔧 Formation — How to build it" icon="🔧" defaultOpen={true}>
          ...
          <div className="rule-box" style={{ marginTop: '1rem' }}>
            <strong>📝 Remember:</strong> The -ing spelling rules are the same as Present Continuous:<br />
            <em>run → run<strong>n</strong>ing · sit → sit<strong>t</strong>ing · make → mak<strong>ing</strong></em>
          </div>
        </Accordion>
        ...
        <Accordion title="📌 When to use Past Continuous — 4 Uses" icon="📌" defaultOpen={true}>
          ...
          <div style={{ background: '#fce7f3', borderRadius: 10, padding: '1rem', marginBottom: '1rem' }}>
            ...
            <p style={{ fontSize: '0.88rem', marginTop: 4, marginBottom: 6 }}>Something was happening at a particular moment in the past.</p>
            ...
            <ExBox correct={true}>He <strong>wasn't sleeping</strong> — he was reading.</ExBox>
          </div>

          <div style={{ background: '#fef3c7', borderRadius: 10, padding: '1rem', marginBottom: '1rem' }}>
            <strong style={{ color: '#92400e' }}>USE 2 — Background Action (Interrupted by Past Simple)</strong>
            <p style={{ fontSize: '0.88rem', marginTop: 4, marginBottom: 6 }}>The longer action that was already in progress when something else happened. This is the most tested use!</p>
            <div className="rule-box">
              <strong>Classic Pattern:</strong><br />
              Past Continuous (background) + <em>when</em> + Past Simple (interruption)<br /><br />
              <em>She <strong>was reading</strong> [ongoing] when the phone <strong>rang</strong> [interruption].</em>
            </div>
            ...
            <ExBox correct={true}>The teacher <strong>was explaining</strong> the rule when the bell rang.</ExBox>
          </div>

          <div style={{ background: '#dcfce7', borderRadius: 10, padding: '1rem', marginBottom: '1rem' }}>
            <strong style={{ color: '#166534' }}>USE 3 — Two Simultaneous Past Actions</strong>
            <p style={{ fontSize: '0.88rem', marginTop: 4, marginBottom: 6 }}>Two actions happening at the same time in the past — use <em>while</em> to connect them.</p>
            ...
            <ExBox correct={true}>I <strong>was listening</strong> to music while I <strong>was doing</strong> my homework.</ExBox>
            <ExBox correct={true}><strong>While</strong> some students <strong>were taking</strong> notes, others <strong>were drawing</strong>.</ExBox>
          </div>

          <div style={{ background: '#eff6ff', borderRadius: 10, padding: '1rem' }}>
            <strong style={{ color: '#1e40af' }}>USE 4 — Setting the Scene in a Story</strong>
            <p style={{ fontSize: '0.88rem', marginTop: 4, marginBottom: 6 }}>At the beginning of a story, use Past Continuous to describe the atmosphere and background.</p>
            <ExBox correct={true}>It <strong>was raining</strong> heavily. A dog <strong>was barking</strong> somewhere in the distance. The streets <strong>were empty</strong>…</ExBox>
            <ExBox correct={true}>The sun <strong>was setting</strong> over the mountains when she finally arrived at the village.</ExBox>
          </div>
        </Accordion>

        {/* WHEN vs WHILE */}
        <Accordion title="🔁 WHEN vs. WHILE — Which one to use?" icon="🔁">
          <div style={{ overflowX: 'auto' }}>
            <table className="tense-table">
              <thead>
                <tr><th>Connector</th><th>Followed by</th><th>Example</th></tr>
              </thead>
              <tbody>
                <tr>
                  <td><strong>when</strong></td>
                  <td>Past Simple (the interruption / point in time)</td>
                  <td><em>She was reading <strong>when</strong> the phone <strong>rang</strong>.</em></td>
                </tr>
                <tr>
                  <td><strong>while</strong></td>
                  <td>Past Continuous (ongoing action)</td>
                  <td><em><strong>While</strong> she <strong>was reading</strong>, the phone rang.</em></td>
                </tr>
              </tbody>
            </table>
          </div>
          <div className="rule-box gold" style={{ marginTop: '0.75rem' }}>
            <strong>💡 Key insight:</strong> <em>When</em> and <em>while</em> can often be swapped if you also swap the tenses:<br /><br />
            <em>She was reading <strong>when</strong> the phone <strong>rang</strong>.</em><br />
            = <em><strong>While</strong> she <strong>was reading</strong>, the phone rang.</em><br /><br />
        ...
        <Accordion title="⚡ Past Simple vs. Past Continuous — Key Contrasts" icon="⚡">
          <div style={{ overflowX: 'auto' }}>
            <table className="tense-table">
              <thead>
                <tr><th>Past Simple</th><th>Past Continuous</th></tr>
              </thead>
              <tbody>
                ...
                <tr><td>Completed past fact<br /><em>The storm <strong>lasted</strong> three days.</em></td><td>In progress at a past moment<br /><em>At 3 PM, it <strong>was still raining</strong>.</em></td></tr>
              </tbody>
            </table>
          </div>
          <div className="rule-box" style={{ marginTop: '0.75rem' }}>
            <strong>🎯 Quick test:</strong> Could you add "and then it stopped" to the action?<br />
            → Yes → Past Simple (completed)<br />
            → No (it was ongoing) → Past Continuous
          </div>
        </Accordion>
        ...
        <Accordion title="⚠️ Most Common Mistakes" icon="⚠️">
          ...
          <ExBox correct={false}>They <strong>were went</strong> to the cinema. ✘ → go is not a continuous verb here; use Past Simple</ExBox>
          <ExBox correct={true}>They <strong>went</strong> to the cinema. ✅</ExBox>
          <ExBox correct={false}>He <strong>was knowing</strong> the answer. ✘ → know is stative, never in continuous</ExBox>
          <ExBox correct={true}>He <strong>knew</strong> the answer. ✅</ExBox>
          <ExBox correct={false}>While she cooked, the phone rang. ✘ → while = ongoing action → needs continuous</ExBox>
      ...
      <div className="card">
        ...
        <Accordion title="📝 Examples — Habits vs. States" icon="✏️">
          <div style={{ background: '#eff6ff', borderRadius: 10, padding: '1rem', marginBottom: '1rem' }}>
            ...
            <ExBox correct={true}>The old building <strong>used to be</strong> a railway station. (being = state)</ExBox>
          </div>
          <div style={{ background: '#f0fdf4', borderRadius: 10, padding: '1rem' }}>
            ...
            <ExBox correct={true}>The kids <strong>used to play / would play</strong> in the park every afternoon. ✅</ExBox>
          </div>
        </Accordion>
      </div>
      ...
      <div className="card">
        ...
        <Accordion title="🔍 Specific Detail Questions" icon="🔍">
          ...
          <div className="rule-box" style={{ marginTop: '0.5rem' }}>
            <strong>Example:</strong> "What obstacles did Marie Curie face?" → Scan for: <em>obstacle, challenge, difficult, not allowed, poor</em> → Find: women banned from university in Poland, poverty in Paris.
          </div>
        </Accordion>
